			...
			<div class="form-muestra">
				...
				<div class="row filas complementaria">
					...
					<div class="col colp col-lg-2 col-md-3 col-sm-4">
						...
						<div class="col colp col-md-12" ><input type="text" class="form-control NA requerido" value="<?php echo $Det_Muestras->Lote ?>" id="lote" /> </div>
					</div>
					<div class="col colp col-lg-2 col-md-3 col-sm-4">
						...
						<div class="col colp col-md-12" >
							<div class="input-group">
					      		...
					      		<select class="select-input" id="unidad">
					      			...
					      			<option value="3" <?php echo ($Det_Muestras->Unidad==3) ? 'selected' :''; ?> >Un</option>
					      		</select></div> 
					    	</div> 
					    </div>
					</div>
				...
				?>
					...
					<div class="col colp col-md-12 th ">
						<p id="titulo_datos" class="<?php echo $ver ?>">Datos en campo (Para decimales utilizar punto)</p>
					</div>
								...
								if (intval($comparador_ap) === 8) { ?>	
									<div class="col colp col-md-3">
										...
										<select class="select-input form-control datoencampo" style="border:1px solid #ccc; background:#fff">
								      		<option value="Ausencia" <?php echo ($DatosEnCampo[$nk]=="Ausencia") ? 'selected' :''; ?> > Ausencia </option>
								      		<option value="Presencia" <?php echo ($DatosEnCampo[$nk]=="Presencia") ? 'selected' :''; ?> > Presencia </option>
								      	</select>
								    </div>
								<?php
									...
									<div class="col colp col-md-3">
										...
										<select class="select-input form-control datoencampo" style="border:1px solid #ccc; background:#fff">
								      		<option value="Positivo" <?php echo ($DatosEnCampo[$nk]=="Positivo") ? 'selected' :''; ?> > Positivo </option>
								      		<option value="Negativo" <?php echo ($DatosEnCampo[$nk]=="Negativo") ? 'selected' :''; ?> > Negativo </option>
								      	</select>
								    </div>
								<?php
									...
									<div class="col colp col-md-3">
										<div class="col colp col-md-12"><?php echo $NombreParametro[$k] ; ?></div>
										<select class="select-input form-control datoencampo" style="border:1px solid #ccc; background:#fff">											
								      		<option value="Aceptable" <?php if ($DatosEnCampo[$nk]=="Aceptable"){ echo 'selected'; } ?>	> Aceptable </option>
								      		<option value="No aceptable" <?php if ($DatosEnCampo[$nk]=="No aceptable"){ echo 'selected'; } ?>	> No Aceptable </option>
								      	</select>
								    </div>
								<?php
									...
									<div class="col colp col-md-3">
										<div class="col colp col-md-12"><?php echo $NombreParametro[$k] ?></div>
										<select class="select-input form-control datoencampo" style="border:1px solid #ccc; background:#fff">
								      		<option value="Fondo visible" <?php echo ($DatosEnCampo[$nk]=="Fondo visible") ? 'selected' :''; ?> > Fondo visible </option>
								      		<option value="Fondo no visible" <?php echo ($DatosEnCampo[$nk]=="Fondo no visible") ? 'selected' :''; ?> > Fondo no visible </option>
								      	</select>
								    </div>
								<?php 
									...
									<div class="input-group">
										<div class="input-group-addon">
								      		<select class="select-input comparador_dc">
								      			<option value="=" <?php echo ($Comparador_dc[$k]=="=") ? 'selected' :''; ?> > = </option>
								      			<option value="<" <?php echo ($Comparador_dc[$k]=="<") ? 'selected' :''; ?> > < </option>
								      			<option value=">" <?php echo ($Comparador_dc[$k]==">") ? 'selected' :''; ?> > > </option>
								      		</select>
							      		</div> 
