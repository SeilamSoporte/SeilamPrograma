...
<html lang="es">
  ...
  <body>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<div class="navbar-form navbar-left" role="search" action="">
				  <div class="form-group" style="margin-top:6px; ">
					<span class="text-primary" style="color:white">*La búsqueda sólo se realizará por Código o Área de análisis </span>
				  </div>
				</div>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="FormParametro"> </div><!-- /.modal-dialog -->
		
	<!-- Modal de confirmación para eliminar-->
	<div class="modal fade" id="confirma" role="dialog" tabindex="-1"></div>

	<!-- Btn nuevo parámetro-->
	<a id="btn_fltn" class="btn-floating fixed-action-btn btn-large waves-effect modal-tr" data-toggle="modal"  title="Nuevo parámetro" data-target="#FormParametro" >
