   ...
   var jQueryDatePickerOptions =
       {
        ...
        $(".ResComparador").change(function(){
            ...
            if ($(this).val()==4){
                ...
                incertidumbre = $("#incertidumbre"+id);
                incertidumbre.val('');
                incertidumbre.prop('disabled', true);
            }
            else if ($(this).val()==5){
                resultado = $("#resultado"+id);
                resultado.prop('type', 'text');
                ...
                incertidumbre = $("#incertidumbre"+id);
                incertidumbre.val('');
                incertidumbre.prop('disabled', false);
            }
            else if ($(this).val()==6){
                resultado = $("#resultado"+id);
                resultado.prop('type', 'text');
                ...
                $("#incertidumbre"+id).prop('disabled', false);
            }
        });
       });
    ...
    $('.reportar').click(function(){
        ...
        if(vacio==false){
            ...
            $.post('../resources/query_resultados.php', params,function(data){
                if (data==1){
                    msg={};
                    msg.action ='1';
