		...
		<div class="col col-md-12">
			...
			<fieldset <?php #echo $field_disabled ?> >
				...
				<div class="row">
					<div class="col col-xs-12" style="padding: 0; margin-top: 15px; margin-bottom: 10px;">
						<div class="col col-md-4"><span class="th">Fecha de ensayo:</span>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
									...
									<div class="input-group">
										<span class="input-group-addon">
											<select class="form-control addon ResComparador" data-id="<?php echo $i ?>"> 
												...
												<option <?php echo ($ResComparador[$i]=='5') ? 'selected': ''?> value="5"> Riesgo </option>
												<option <?php echo ($ResComparador[$i]=='6') ? 'selected': ''?> value="6"> N/A </option>
											</select>	
										</span>
										<?php if(isset($ResComparador[$i])){
											$Type 	  = ($ResComparador[$i]==4) ? 'text'  	: 'number';
											$disabled = ($ResComparador[$i]==4 || $ResComparador[$i]==6) ? 'disabled'  : ''; 
										} 
										?>
										<?php if(isset($ResComparador[$i])){
											$Type 	  = ($ResComparador[$i]>=5) ? 'text'  	: 'number';
										} 
							...
							<!-- <input type="text" class="form-control resultado" value="<?php echo $Resultado ?>">-->
							</td>
							<td class="col-xs-3">
