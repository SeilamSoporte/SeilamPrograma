...
$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $('#codigo').change(function(e){
        ...
        $("#datos_campo").html('');
        $("#caracteristicas_o").addClass('hide');
        ...
        $.post("../../mod_parametros/resources/QueryS_Parametros.php", datos, function(data)
        {
            ...
            var visible = Array();
            if (dato[2].search("Agua")===0){
                $("#caracteristicas_o").removeClass('hide');
            }
            ...
            $.each(tipos, function (ind, elem) { 
                if (parseInt(elem)===5){
                cell_datC.load('../resources/datos_campo.php',{PID:PID});
    ...
    function buscarPal(selector, texto, campo){
        ...
        $('#estado_tiempo').prop("disabled", false);
