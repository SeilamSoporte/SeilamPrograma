$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $('.load_informe').click(function(){ 
        ...
        $("#volver").click(function(){
                usuario=$("#usuario_logeado").attr('data-id');
                $("#form_insert").html('<form action="../index.php" id="form" name="form" method="post" style="display:none;"> <input type="text" name="valida" value="true" /><input type="text" name="user" value="'+usuario+'" /></form>' );
                $("#form").submit();
        });
        ...
        $('.generarInf').click(function(){
            ...
            //alert('Se generará un informe pdf');
            url = '../informeMembrete.php?id='+id+'&cn='+cons;
            window.open(url, '_blank');
            return false;
        });         

        $('.generarInf2').click(function(){
            var cons = $('#datos').attr('data-cn');
            var id   = $('#datos').attr('data-id');
            caractereres = "0123456789abcdfghijklmnopqrstuvwxyzABFDFHIJKLMNOPQRSTUVWXYZ";
            longitud     = 5;
            ...
            //alert('Se generará un informe pdf');
            url = '../informeMembrete2.php?id='+id+'&cn='+cons;
            window.open(url, '_blank');
            return false;
        });         
         
        $('.generarInf2NL').click(function(){
            var cons = $('#datos').attr('data-cn');
            var id   = $('#datos').attr('data-id');
            caractereres = "0123456789abcdfghijklmnopqrstuvwxyzABFDFHIJKLMNOPQRSTUVWXYZ";
            longitud     = 5;
