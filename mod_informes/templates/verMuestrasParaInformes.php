<?php 
    ...
    $usuario_logeado    = isset($_POST['usuario_logeado']) ? $_POST['usuario_logeado']: '';
    ...
    <header>
        <nav class="navbar navbar-dark navbar-fixed-top hidden-print">
          <div class="container-fluid">
            ...
            <div id="usuario_logeado" data-id="<?php echo $usuario_logeado ?> "></div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav navbar-right ">
 
                <li class ="btn-dark hidden generar" >    
                    <a href="#" id="pdf" class="btn-cmd" data-toggle="modal" data-placement="bottom" title="PDF para imprimir">
                        <i class="fa fa-print fa-2x ">&nbsp;</i>
                    </a>
                </li>
                <li class ="btn-dark hidden generarInf" > 
                    <a href="#" id="pdf" class="btn-cmd" data-toggle="modal" data-placement="bottom" title="PDF para email">
                        <i class="fa fa-at fa-2x ">&nbsp;</i>
                    </a>
                </li>
                <li class ="btn-dark hidden generarInf2" > 
                    <a href="#" id="pdf" class="btn-cmd generarInf2NL" data-toggle="modal" data-placement="bottom" title="PDF">
                        <i class="fa fa-files-o fa-2x ">&nbsp;</i>
                    </a>
                </li>
 
                <li class ="btn-dark" id="logout">
                    <a href="#" id="volver" class="btn-dark" data-toggle="modal" data-placement="bottom" title="Volver">
