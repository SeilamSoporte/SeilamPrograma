...
<div class="container-report">
	...
	<div class="box ">
		...
		<div class="row" style="line-height:95%; font-size:8pt">
			<div class="col col-xs-6">
				...
				<div class="row"> 
					<div class="col col-xs-5 th">Descripción:		</div><div class="col col-xs-7 td"><?php echo  $Descripcion ?></div>
				</div>
				<div class="row"> 
				...
				<div class="row"> 
					<div class="col col-xs-5 th">Fecha y hora de recolección:	</div><div class="col col-xs-4 td"><?php echo  $Fecha_Hora_R ?></div>
				</div>

			</div>
			<div class="col col-xs-6" style="line-height:95%; font-size:8pt">
				<div class="row"> 
					<div class="col col-xs-5 th-m">Fecha y hora de ingreso:		</div><div class="col col-xs-6 td"><?php echo  $Fecha_Hora_I  ?></div>
				</div>
				<div class="row"> 
					<div class="col col-xs-5 th-m">Temperatura de ingreso: 		</div><div class="col col-xs-6 td"><?php echo  formato($TemperaturaIngreso)  ?></div>
				</div>
				<div class="row hide  <?php echo $FQA ?> <?php echo $MBA ?> <?php echo $ALMB ?>"> 
					<div class="col col-xs-5 th-m">Cantidad:					</div><div class="col col-xs-6 td"><?php echo  $Cantidad  ?></div>
				</div>
				<div class="row hide <?php echo $ALMB ?>"> 
					<div class="col col-xs-5 th-m ">Fecha de producción:		</div><div class="col col-xs-6 td"><?php echo  $Fecha_produccion  ?></div>
				</div>
				<div class="row  hide <?php echo $ALMB ?>"> 
					<div class="col col-xs-5 th-m">Fecha de vencimiento:		</div><div class="col col-xs-6 td"><?php echo  $Fecha_vencimiento  ?></div>
				</div>
				<div class="row hide <?php echo $ALMB ?> <?php echo $FR ?> <?php echo $PL ?>"> 
					<div class="col col-xs-5 th-m">Lote:						</div><div class="col col-xs-6 td"><?php echo  $Lote  ?></div>
				</div>
				<div class="row hide <?php echo $FR ?> <?php echo $PL ?>"> 
					<div class="col col-xs-5 th-m">Medio:						</div><div class="col col-xs-6 td"><?php echo  $Medio  ?></div>
				</div>
				<div class="row hide <?php echo $FQA ?> <?php echo $MBA ?>"> 
					<div class="col col-xs-5 th-m">Estado del tiempo:		    </div><div class="col col-xs-6 td"><?php echo  $Estado  ?></div>
				</div>
				<div class="row <?php echo $FQA ?>"> 
					<div class="col col-xs-5 th-m">Lugar/Punto de muestreo:		</div><div class="col col-xs-6 td"><?php echo  $LugarM  ?></div>
				</div>				
			</div>
	...
	<div class="box <?php echo $clase_box_resultados ?>">
		...
		<?php 
			...
			foreach ($NParametros as $Parametro => $value) {
				...
				if ($Incertidumbre==''){ $Incertidumbre = 'NR';	}
				else{ $Incertidumbre = formato($Incertidumbre,2,',',' ');}
			...
			<div class="row par bbl" style="font-size:0.8em; line-height: 0.8em; ">
				...
				<div class="col col-xs-25 td-i col-tdi "> <?php echo $Metodo[$i-1] ?></div>
				<div class="col col-xs-2 td-i col-tdi text-center"><?php echo $Norma[$i-1] ?> </div>
				<div class="col col-xs-15 td-i col-tdi text-center"><?php echo formato($ValorReferencia) ?> </div>
				...
				<!-- <div class="col col-xs-1 td-i col-tdi text-left"><?php echo $R_Cumple ?> </div>	 -->
					<?php } ?>
	...
	<div class="row" style="padding-bottom: 0px;">
		<div class="col col-xs-12 text-center hd linea">FORMALIZACIÓN DEL REPORTE</div>
			
				<div class="col col-xs-12 notas"><strong>Nota aclaratoria:</strong> Los resultados sólo están relacionados con los ítems ensayados
				<br>Este documento no se puede reproducir sin la aprobación escrita de SEILAM S.A.S.
				</div>			
	</div>
	...
	<div class="row" >
		<div class="col col-xs-15 firmas text-center"> <?php echo $ImgFirmaR ?> </div>
	...
	<div class="row">
		<div class="col col-xs-15 firmas "><?php echo $ImgFirmaR ?></div>
...
<div class="row">
	<div class="col col-xs-12 text-center barra-fin">
		<span>FINAL DEL INFORME DE ENSAYOS <?php echo $NroInforme ?></span>
	</div>
</div>
</div>
<script>