...
<div class="container-report">
		...
		<div class="row">
			...
			<div class="col col-xs-6">
				...
				<div class="row">
					...
					<div class="col col-xs-6 td"><?php echo  $TemperaturaIngreso  ?>
					</div>
				</div>
				<div
	...
	<div class="box <?php echo $clase_box_resultados ?>">
		...
		<div class="<?php echo $clase_datos ?>">
			...
			<?php if ($Area == 'Fisicoquímico') { ?>
			<div class="row par bbl">
				<div class="col col-xs-3 td-i col-tdi  "> <?php echo $Parametro ?>
				</div>
				...
				<div class="col col-xs-15 td-i col-tdi text-center"><?php echo $ValorReferencia ?>
				</div>
...
<div class="row" style="padding-bottom: 1px;">
	<div class="col col-xs-8"><strong>Autorización del Informe de Ensayos</strong> <span style="font-size: 0.75em">
...
<table name='footer' width="100%" cellspacing='0'
	...
	<tr>
		<td align="center"><img style='height:45px; line-height:1' <?php echo $FirmaRi ?> > </td>
		<!-- <td align="center"><img style='height:45px; line-height:1' <?php echo $FirmaAi ?>
		> </td>-->
	</tr>

	<tr>
		<td style='font-size: 11px; line-height:1' align="center"><strong><?php echo $FirmaR ?></strong> </td>
		<!-- <td style='font-size: 11px; line-height:1' align="center"><strong><?php echo $FirmaA ?></strong>
		</td>-->
	</tr>
	<tr>
		<td style='font-size: 9px; line-height:1' align="center"><?php echo $CargoR ?>
		</td>
		<!--<td style='font-size: 9px; line-height:1' align="center"><?php echo $CargoA ?>
		</td>-->
	</tr>
	<tr>
		<td colspan="2" style='font-size: 9px; line-height:1' align="center">FINAL DEL INFORME DE ENSAYOS <?php echo $NroInforme ?>
		</td>
