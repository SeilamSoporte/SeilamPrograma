...
<div class="box">
	<div class="row resultados">
		<div class="col col-xs-12 centrado hd">ANÁLISIS MICROBIOLÓGICOS</div>
	</div>
...
*/
		...
		<div class="row" style="line-height: 0.8em">
			<div class="col col-xs-4 td-i" style="width:30%"> <?php echo $Parametro ?>
			</div>

			<div class="col col-xs-3 td-i" style="width:120px"> <?php echo $Metodo[$i-1] ?>
			</div>

			<div class="col col-xs-1 td-i" style=" width:12%"> <?php echo $Norma[$i-1] ?>
			</div>
			<div class="col col-xs-1 td-i" style="text-align:center; width:11.5%"> <?php echo formato($ValorReferencia) ?>
			</div>
			<div class="col col-xs-1 td-i" style="text-align: center"> <?php echo formato($ResultadoComp) ?>
			</div>
			<?php if ($conIncertidumbreMB==true) { ?>
			<div class="col col-xs-1 td-i" style="width: 100px; text-align: center;"> <?php echo formato($IncertidumbreMB) ?>
			</div>
			<?php } ?>
			<!-- 			
