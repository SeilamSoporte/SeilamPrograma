...
-->			
		...
		<?php 
			...
			<div class="row">
				...
				<div class="col col-xs-2 td-dc"><?php echo formaton($ValorReferencia_dc) ?> </div>
				<div class="col col-xs-1 td-dc"><?php echo isset($Resultado_dc[$j]) ? formaton($Resultado_dc[$j] ): '' ?> 
			</div>
<!-- 				
