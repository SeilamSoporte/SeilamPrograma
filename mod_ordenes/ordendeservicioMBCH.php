...
$header = ' <table style="height:50px; font-size:9pt; width:100%; border-collapse: collapse" border="1">
				<tr>
					...
					<td rowspan="4" style="width:60%; text-align: center;">Orden de servicio laboratorio de Microbiología- Control Higiene 
					<br>('.$desde.'/'.$hasta.')</td>
					<td style="width:20%; font-size:7pt; border:0 ; border-right:1px solid #000; border-top:1px solid #000; padding:3px 0 0 10px ">CODIGO: F-MB-43</td>
				</tr>
				<tr>
...
/*$mpdf->SetHeader('|Orden de servicio laboratorio de Microbiología- Control Higiene|('.$desde.'/'.$hasta.')');*/
