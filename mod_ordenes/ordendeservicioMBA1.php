...
/*
$mpdf->SetHTMLHeader('<table border=1 width="100%" style="text-align: center; font-weight: bold;">
	<tr>
	<td><img src="../Mod_empresa/imgs/'.$Logo.'" style="height:50px;"> </img></td>
	<td>Oden de servicio laboratorio de Microbiología - Aguas</td>
	<td style="width:50px">
	CÓDIGO:P-FQ-01
	VERSIÓN:02
	FECHA:'.$desde.'/'.$hasta.'
		...
		<?php 
		 	...
		 	$TipoParam 	  = explode("|",$params['Tipo']);
		 		foreach ($IdParametros as $k=>$Id) {
		 			if($TipoParam[$k] ==$tipo && ($NCat==4 || $NCat==5)){
