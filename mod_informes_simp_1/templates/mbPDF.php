<?php 
	...
	$Anotaciones   	= isset($Detalles[0]) ? $Detalles[0]['Anotaciones']: ''; 
...
?>
	...
	<div class="box">
		...
		<div class="row head-i">
			...
			<div class="col col-xs-3 th-i">Método </div>
			<div class="col col-xs-1 th-i" style="padding-right: 10px; width: 8.5%">Norma de Referencia </div>
