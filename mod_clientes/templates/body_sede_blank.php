										...
										<td>										
											<div class="col col-md-6">
												<div class="input-group">
													...
													<input value = "" type="text" id="SedeS" class="form-control SedeS" placeholder="Sede" aria-describedby="basic-addon-sede">
												</div>
											</div>
											...
											<div class="col col-md-6">
												<div class="input-group">
													...
													<input value = "" type="text" id="DireccionS" class="form-control DireccionS" placeholder="Direccion" aria-describedby="basic-addon-dir">
												</div>
											</div>
											...
											<div class="col col-md-6">
												<div class="input-group">
													...
													<input value = "" type="text" id="CiudadS" class="form-control CiudadS" placeholder="Ciudad" aria-describedby="basic-addon-ciudad">
												</div>
											</div>
											...
											<div class="col col-md-5">
												<div class="input-group">
													...
													<input value = "" type="text" id="TelefonoS" class="form-control TelefonoS" placeholder="Telefono" aria-describedby="basic-addon-telefono">
												</div>
											</div>											
											
											<div class="eliminar col col-md-1">
												<div style="width:40px">
													<a class="delete_sede" id="eliminarSedes" > 
