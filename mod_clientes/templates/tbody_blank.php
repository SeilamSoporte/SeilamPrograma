										...
										<td>										
											<div class="col col-md-6">
												<div class="input-group">
													...
													<input value = "" type="text" id="Contacto" class="form-control Nombre_c" placeholder="Contacto" aria-describedby="basic-addon-c0ntacto">
												</div>
											</div>
											...
											<div class="col col-md-6">
												<div class="input-group">
													...
													<input value = "" type="text" id="Cargo" class="form-control Cargo_c" placeholder="Cargo" aria-describedby="basic-addon-cargo">
												</div>
											</div>
											...
											<div class="col col-md-6">
												<div class="input-group">
													...
													<input value = "" type="text" id="Email_C" class="form-control Email_c" placeholder="Email" aria-describedby="basic-addon-email">
												</div>
											</div>
											...
											<div class="col col-md-5">
												<div class="input-group">
													...
													<input value = "" type="text" id="Celular" class="form-control Celular_c" placeholder="Celular" aria-describedby="basic-addon-celular">
												</div>
											</div>											
