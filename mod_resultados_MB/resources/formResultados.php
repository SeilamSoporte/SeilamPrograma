...
?>
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="modal-title">Resultados de las muestras Microbilógicas</h4> 
			</div>	  
							...
							<div class="col col-md-12">
								<?php foreach($Datos as $Detalles){ ?>
									<?php 
									 ...
									 ?>
									<button type="button" id="<?php echo $Detalles['CN'] ?>" data-id="<?php echo $Detalles['CN'] ?>" class="btn <?php echo $btn ?> load_muestra">
