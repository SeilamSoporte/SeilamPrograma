					...
					<div class="defualt codigoI" data-id="<?php echo $D_Muestra->Codigo ?>" style="text-align:center"><strong>CÓDIGO DE INGRESO Nº <?php echo $D_Muestra->Codigo ?></strong></div>
								...
								<select name="Sede" id="sede" class="form-control">									
									<?php 
										foreach ($sedes as $S=>$Sede) {
											echo "
											<option " . ($D_Muestra->Sede == $S ? "selected " : '') . "value='".$S."'>".$sedes[$S]."
											</option>";
										}
									?>		
								</select>
						...
						<div class="row">
							<div class="col col-md-3">
								...
								<input id="Fecha_ingreso" name="Fecha_ingreso" class="form-control fechaJQ" type="text" value=<?php echo $D_Muestra->Fecha_I ?>  />
							</div>
							<div class="col col-md-3">
	...
	<div class="modal-content">  
	    ...
	    <div class="modal-body">
			 ...
			 <div class="form-horizontal">
				...
				<div class="row filas parametros">
					<div class="col colp col-lg-6 col-md-6 col-sm-4 form-input">
					...
					<div class="col colp col-lg-1 col-md-3 col-sm-2 form-input">
